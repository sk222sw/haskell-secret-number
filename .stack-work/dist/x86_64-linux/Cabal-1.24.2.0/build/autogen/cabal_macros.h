...
/* package secret-number-0.1.0.0 */
#define VERSION_secret_number "0.1.0.0"
#define MIN_VERSION_secret_number(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "secret-number-0.1.0.0-JmbaCzQ9kHe3qtWvkJTx9K"

#define CURRENT_PACKAGE_KEY "secret-number-0.1.0.0-JmbaCzQ9kHe3qtWvkJTx9K"
